...
import { Waves, Volume2, VolumeX, Play, Pause, CheckCircle } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Slider } from "@/components/ui/slider";
import { Progress } from "@/components/ui/progress";

const BREATH_DURATION = 8; // seconds for one wave motion
const SESSION_DURATION = 5 * 60; // 5 minutes (in seconds)

interface OceanWavesProps {
  onComplete?: () => void; // callback when session finishes
}
    ...
    return (
      <div className="flex flex-col items-center justify-center h-[400px] space-y-6">
        ...
        <p className="text-lg font-semibold text-center text-muted-foreground">
          Great job! You’ve completed your 5-minute wave relaxation session.
        </p>
